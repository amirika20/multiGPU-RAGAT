...
class Runner(object):
    ...
    def load_data(self):
        ...
        #print(self.triples['train'][0])
        #print(self.triples['train'][1])
        #print(len(self.triples['train']))
        #for i in range(20):
        #    print(self.triples['train'][i]['triple'])
        #print(list(self.sr2o.items())[:5])
    ...
    def run_epoch(self, epoch, val_mrr=0):
        ...
        for step, batch in enumerate(train_iter):
            ...
            print(sub.shape, rel.shape, neg_ent)
...
if __name__ == '__main__':
    ...
    model = Runner(args)
    model.run_test(torch.tensor([10000]*1024), torch.tensor([100]*1024))
    model.run_test(torch.tensor([12000]*1024), torch.tensor([150]*1024))
    #model.fit()
